...
const PROGRAMA = {
  ...
  "Qua · 24/06": { sci:"17h30–18h30", youtube:"https://www.youtube.com/watch?v=WGu-ALY8jBM",
    orais:[
      { tc:"TC1", hora:"13h30", area:"Endocrinologia", ap:"Nicolas Vendrame Crippa", titulo:"Apresentação síncrona de três subtipos distintos de carcinoma tireoidiano: um relato de caso", uc:"Samantha Cristiane Lopes" },
      { tc:"TC2", hora:"14h10", area:"Endocrinologia", ap:"Isabella Schiestl Grudtner", titulo:"Manejo terapêutico e desfechos materno-fetais associados ao diabetes mellitus gestacional: estudo de coorte retrospectiva", uc:"Samantha Cristiane Lopes" },
      { tc:"TC3", hora:"14h50", area:"Endocrinologia", ap:"Beatriz Meinicke da Silva", titulo:"Internações por cetoacidose diabética em um hospital terciário do sul do Brasil: perfil clínico e epidemiológico, manejo e desfechos em uma coorte retrospectiva", uc:"Samantha Cristiane Lopes" },
      { tc:"TC4", hora:"15h30", area:"Endocrinologia", ap:"Yasmim Antunes Rodrigues", titulo:"Deficiência isolada de GH diagnosticada precocemente e evolução terapêutica: um relato de caso", uc:"Franciani Rodrigues da Rocha" },
      { tc:"TC5", hora:"16h10", area:"Endocrinologia", ap:"Laila Maria Longen", titulo:"Terapia combinada com linagliptina, verapamil e vitamina D para preservar a reserva pancreática no diabetes autoimune latente do adulto (LADA): relato de caso", uc:"Franciani Rodrigues da Rocha" },
      { tc:"TC6", hora:"16h50", area:"Endocrinologia", ap:"Maiara Letícia Willers Carrard", titulo:"Inteligência artificial na classificação de nódulos tireoidianos indeterminados: revisão sistemática de evidências ultrassonográficas e multimodais", uc:"Samantha Cristiane Lopes" },
    ],
    posteres:[
